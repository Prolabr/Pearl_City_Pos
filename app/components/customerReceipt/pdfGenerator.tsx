...
  
  // --- Logo Placement (Higher and smaller) ---
  // x=15, y=5, width=40, height=40
  doc.addImage(logoImg, "PNG", 15, 5, 40, 40); 
  
  // --- Header Section (Positioned centrally) ---
  let headerY = 15; // Start centered text here
...
    { align: "center" }
  );
  // currentY (55) now indicates the start of the content below the header block
...
    if (isChecked) {
      doc.setFontSize(10);
      doc.text("X", checkboxX + checkboxSize / 2, currentY - 1, { align: "center" });
      doc.setFontSize(10);
    }
...
      doc.setFontSize(8);
      doc.text("If other specify", labelX + 15 + otherBoxWidth + 2, currentY - 0.5);
      doc.setFontSize(10);
    }
...
    headStyles: { fillColor: [255, 255, 255], textColor: 0, halign: "center", fontStyle: "normal" },
    bodyStyles: { textColor: 0, halign: "center" },
    columnStyles: { 0: { cellWidth: bodyWidth * 0.25 }, 1: { cellWidth: bodyWidth * 0.25 }, 2: { cellWidth: bodyWidth * 0.25 }, 3: { cellWidth: bodyWidth * 0.25 } },
  });
...
  doc.line(customerSigX, signatureLineY, customerSigX + signatureLineLength, signatureLineY);
  doc.text("Signature of the customer", customerSigX + 5, signatureLineY + signatureGap);

  // Money Changer Signature
  const changerSigX = pageWidth - margin - signatureLineLength;
  doc.line(changerSigX, signatureLineY, changerSigX + signatureLineLength, signatureLineY);
  doc.text(
